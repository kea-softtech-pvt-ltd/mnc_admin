                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    <div class="panel-heading">
                                        <div class="btn-group"> 
                                            <a class="btn btn-primary" href="manage-logo.php"> <i class="fa fa-list"></i>  Manage Logo </a>  
                                        </div>
                                    </div>
                                        ...
                                        <form method="post" id="registration" name="registration" enctype="multipart/form-data" class="col-sm-12">
                                            ...
                                            <div class="col-md-8 form-group">
                                             ...
                                             <label class="radio-inline">
                                                 ...
                                                 <label class="radio-inline"><input type="radio" name="type" id="type" value="0" checked="checked">Non Default</label>
                                             </div>
